...
import com.foxnet.rmi.util.concurrent.FutureCallback;
...
public final class DefaultSessionServer<T> implements AdminSessionServer<T> {
	...
	private final Map<Long, Session<T>> sessions = new HashMap<>();
	...
	private final ChangeableQueue<T> local,
			broadcast = new DefaultChangeableQueue<>(new Changeable<T>() {
				@Override
	 ...
	 * 
	 * @see
	 * com.foxnet.rmi.pattern.change.AdminSessionServer#acceptingSessions(boolean
	 * )
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.foxnet.rmi.pattern.change.AdminSessionServer#composite()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.foxnet.rmi.pattern.change.AdminSessionServer#sessionMap()
	 */
	@Override
