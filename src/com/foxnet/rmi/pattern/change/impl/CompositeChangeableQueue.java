...
import com.foxnet.rmi.pattern.change.ChangeableQueue;
...
public final class CompositeChangeableQueue<T> implements ChangeableQueue<T> {
	 ...
	 */
	private final List<ChangeableQueue<T>> changeableQueues = new LinkedList<>();
	 ...
	 * 
	 * @see
	 * com.foxnet.rmi.pattern.change.Changeable#applyChange(com.foxnet.rmi.pattern
	 * .change.Change)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.foxnet.rmi.pattern.change.ChangeableQueue#applyChangeLater(com.foxnet
	 * .rmi.pattern.change.Change, java.util.Collection)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.foxnet.rmi.pattern.change.ChangeableQueue#applyQueuedChangesLater
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.foxnet.rmi.pattern.change.ChangeableQueue#applyQueuedChanges()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.foxnet.rmi.pattern.change.ChangeableQueue#mergeQueuedChanges()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.foxnet.rmi.pattern.change.ChangeableQueue#queueChange(com.foxnet.
	 * rmi.pattern.change.Change, boolean)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.foxnet.rmi.pattern.change.ChangeableQueue#removeQueuedChanges()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.foxnet.rmi.pattern.change.ChangeableQueue#separateQueuedChanges()
	 */
	@Override
